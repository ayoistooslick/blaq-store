              ...
              <div ref={profileRef} style={{ position: 'relative' }}>
                <button
                  ...
                  style={{
                    ...
                    padding: '0.45rem 0.85rem', borderRadius: 'var(--radius)',
                ...
                >
                  ...
                  <FiChevronDown size={14} style={{ color: 'var(--text-muted)', transition: 'transform 0.2s', transform: profileOpen ? 'rotate(180deg)' : 'none' }} />
                </button>
                ...
                {profileOpen && (
                  <div style={{
                    ...
                    >
                      <RiDashboardLine size={15} color="var(--text-muted)" />
                      Dashboard
                    </Link>
                    <button
        ...
        >
          ...
          {user && (
            <>
              ...
              <Link to="/dashboard" onClick={close} style={{
                display: 'flex', alignItems: 'center', gap: '0.65rem',
                padding: '0.85rem 1rem', borderRadius: 'var(--radius)',
                fontSize: '0.95rem', fontWeight: 600,
          ...
          {!user && (
            <Link to="/auth" onClick={close} style={{
              ...
              padding: '0.9rem', borderRadius: 'var(--radius)',
